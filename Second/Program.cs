...
namespace PracticeC_
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            Console.WriteLine($"   По умолчанию: {ls1}");

            LineSegment ls2 = new LineSegment(2, 3, 5, 7);
            Console.WriteLine($"   С параметрами: {ls2}");

            LineSegment ls3 = new LineSegment(ls2);
            Console.WriteLine($"   Копирование: {ls3}");

            // Тест метода Contains
            Console.WriteLine("\n2. ТЕСТ Contains:");
            Console.WriteLine($"   Отрезок ls2: {ls2}");
            ...
            Console.WriteLine($"   Исходный: {ls6}");
            Console.WriteLine($"   ls6 + 10 = {ls6 + 10}");
            Console.WriteLine($"   5 + ls6 = {5 + ls6}");

            // Тест операторов сравнения
            Console.WriteLine("\n6. ТЕСТ ОПЕРАТОРОВ СРАВНЕНИЯ:");
            LineSegment ls7 = new LineSegment(2, 0, 8, 0);
            Console.WriteLine($"   Отрезок: {ls7}");
